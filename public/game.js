...
// Объявление текстур (без установки src)
let playerImage = new Image();
let baseImage = new Image();
let zombieImage = new Image();
let backgroundImage = new Image();

// Функция для асинхронной загрузки текстур
...
const shopInputCooldown = 200; // 200 мс для debounce
const weaponSwitchCooldown = 200; // 200 мс для debounce переключения оружия
...
// Запуск игры после загрузки текстур
